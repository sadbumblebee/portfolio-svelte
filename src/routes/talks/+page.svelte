...
<p>When possible I've linked to slides, audio and video from my past events.</p>
<ul>
{#each talksData as talk}
    <li class="talk-container">
...
<p>Want to connect about a talk?</p>
</div> -->
</div>
